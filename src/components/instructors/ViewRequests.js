...
const ViewRequests = () => {
  ...
  useEffect(() => {
    console.log("user details after filter", UserDetails);
  },[UserDetails]);
  ...
  return (
    <div style={{ marginTop: "70px", marginBottom: "70px" }}>
      <center>
          <div>
           <h2 style={{ color: "black", fontSize: "30px" }} class="animate-charcter"><b>Client Requests</b></h2>
        </div>
      </center>
      <br />
      <Container>
